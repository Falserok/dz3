public class Truck extends VehicleQueue implements Vehicle, Runnable {

    private Road road;
    private GasStation gasStation;
    private float tankCapacity = 60;
    private float fuel = 60;
    private float fuelConsumption = 15;
    private String name;

    public Truck(String name, Road road, GasStation gasStation) {
        this.name = name;
        this.road = road;
